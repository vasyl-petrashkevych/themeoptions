...
class ThemeOptionsAdmin {
	public static function init() {
		add_action( 'admin_menu', [ 'ThemeOptionsAdmin', 'admin_menu' ] );
		add_action( 'admin_init', [ 'ThemeOptionsAdmin', 'admin_init' ] );
		add_action( 'admin_enqueue_scripts', [ 'ThemeOptionsAdmin', 'register_scripts' ] );
	}
	...
	public static function admin_menu() {
		add_options_page(
			...
			'manage_options',
			'theme_options',
			[ 'ThemeOptionsAdmin', 'options_page' ],
		);
	}
